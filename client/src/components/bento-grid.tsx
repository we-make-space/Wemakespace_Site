    ...
    <section id="services" className="py-8 min-[375px]:py-12 sm:py-16 md:py-20 bg-background relative overflow-hidden">
      ...
      <div className="container px-3 min-[375px]:px-4 sm:px-6 mx-auto relative z-10 max-w-[100vw]">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 min-[375px]:mb-8 sm:mb-12 md:mb-16 gap-4 min-[375px]:gap-6 sm:gap-8">
          ...
          >
            <h2 className="text-xl min-[375px]:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-8xl font-black mb-3 min-[375px]:mb-4 sm:mb-8 leading-[1.05] min-[375px]:leading-[0.95] sm:leading-[0.9] uppercase tracking-tighter text-foreground break-words overflow-visible">
              The <span className="text-primary sm:text-transparent sm:bg-clip-text sm:bg-gradient-to-r sm:from-primary sm:to-secondary italic">Architecture</span> <br/> of Tomorrow.
            </h2>
