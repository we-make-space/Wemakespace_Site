...
export function IconicProject() {
  return (
    <section className="py-12 sm:py-16 md:py-24 lg:py-32 xl:py-40 bg-background relative overflow-hidden">
      ...
      <div className="w-full box-border pl-4 pr-4 sm:pl-6 sm:pr-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-display font-black text-foreground leading-[0.95] sm:leading-none tracking-tighter max-w-[90vw] sm:max-w-none">
          ...
          <motion.div
            ...
            className="relative rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[3rem] lg:rounded-[4rem] overflow-hidden border border-foreground/10 aspect-video md:aspect-[21/9] bg-muted shadow-xl sm:shadow-2xl bg-orange-400 min-h-[220px] sm:min-h-[260px] md:min-h-0"
          >
            <img 
              src="/fashnect_image_vendor.png" 
              alt="Fashnect Interface" 
              className="w-full h-full object-cover sm:object-scale-down object-center opacity-80 group-hover:scale-105 transition-transform duration-1000"
            />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-10 lg:p-12 xl:p-20 flex flex-col md:flex-row justify-between items-stretch md:items-end gap-4 sm:gap-6 md:gap-8">
              <div className="max-w-xl text-left min-w-0">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-display font-bold text-foreground mb-2 sm:mb-4 md:mb-6 leading-tight">
                  Buy, Sell, Express - fashnect.
                </h3>
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-foreground font-light leading-snug sm:leading-relaxed line-clamp-2 sm:line-clamp-none">
              ...
              <a
                ...
                className="min-h-[44px] sm:min-h-[48px] bg-foreground text-background px-5 sm:px-6 md:px-8 lg:px-12 py-3 sm:py-4 md:py-5 lg:py-6 rounded-full font-black text-xs sm:text-sm md:text-base lg:text-xl uppercase tracking-[0.1em] sm:tracking-widest flex items-center justify-center gap-2 sm:gap-4 hover:bg-primary hover:text-white transition-all shadow-2xl shrink-0"
              >
                Learn More
