...
CREATE INDEX IF NOT EXISTS idx_platform_sections_platform ON platform_sections(platform_id);
CREATE INDEX IF NOT EXISTS idx_articles_order ON articles(order_index);
CREATE INDEX IF NOT EXISTS idx_platforms_order ON platforms(order_index);
...
CREATE INDEX IF NOT EXISTS idx_bento_items_order ON bento_items(order_index);
CREATE INDEX IF NOT EXISTS idx_features_order ON features(order_index);
...
DROP POLICY IF EXISTS "Public read access" ON article_categories;
DROP POLICY IF EXISTS "Public read access" ON articles;
DROP POLICY IF EXISTS "Public read access" ON platforms;
DROP POLICY IF EXISTS "Public read access" ON platform_sections;
DROP POLICY IF EXISTS "Public read access" ON team_members;
DROP POLICY IF EXISTS "Public read access" ON testimonials;
DROP POLICY IF EXISTS "Public read access" ON solutions;
DROP POLICY IF EXISTS "Public read access" ON bento_items;
